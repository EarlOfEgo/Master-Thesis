...
The performance differences between \textsc{BaseX} and the standard Android database SQLite3 is also illustrated and which of both should be prefered for a specific domain.
