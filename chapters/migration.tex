...
As a result of this an installable apk file will be created by the build process.
...
The difference to a normal Android project is that this project is not being build into an apk file, it is being used by other Android projects which pull it in their apk and build it with their code.
...
%TODO:explain the Android project structure
