...
To execute Java code a virtual machine is required, which executes the compiled Java code.
...
Even if it is faster than other interpreted languages, it is still slower than code that is compiled into a machine language, which is executed directly on the hardware.
