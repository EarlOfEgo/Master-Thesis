...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.6]{images/stack-based-addition.png} 
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.6]{images/register-based-addition.png} 
...
This is the result of the different format of the executable virtual machine code, which is illustrated in Chapter~\ref{sec:comparison-of-the-two-byte-code-formats}.
%In general it could not be said which type of virtual machine is the best.
%It depends how the target hardware platform is specified, this could be reason why the JVM is a stack based virtual machine.
%One advantage of stack based machines is that those machines do not need many information about the hardware they are using.
%Which makes it easer to execute on many different hardware environments, which is one of the main goals the JVM has.~\cite{lindholm2013java}\\
