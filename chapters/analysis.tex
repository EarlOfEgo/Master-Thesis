...
%Calculating the increase in percents for all queries with performed on the two biggest databases, it is Query 2 which time consumption increases the most, namely 61\%.
%As a result of those circumstances these two queries will be recorded by using Traceview, executed on the two biggest databases. 
\\
