...
Therefore in this section the constraints have been searched, which are the maximal boundary for using \textsc{BaseX} on a mobile environment.
...
\begin {tabular} {|r|r|r|r|r|r|r|}
	...
	Contacts&SQLite3&BaseX&SQLite3&BaseX&SQLite3&BaseX\\
	\hline
	10&4.39&9.67&32.65&9.85&4.18&19.16\\
...
\\
Those results illustrate that applications with a many queries should use SQLite3 and application with a huge insert and delete ratio should prefer \textsc{BaseX} as their database system.
Especially applications for collecting data should use \textsc{BaseX}, because the more data is collected the bigger the size of the database will get.
