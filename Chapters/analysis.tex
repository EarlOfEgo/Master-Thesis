...
Even if this part of the \textsc{BaseX} Android source code is compiled into native machine code it is still very slow.
...
%TODO: über die eq methode schreiben. ANALYSIEREN ETC.
...
At this place the differences between the two platforms have an important part, because it is best practices to use getter and setter for the normal Java environment, but it is expensive for the Android platform.~\cite{toninievlautatingandroid} 
